    ...
    <div class="bg-gray-900 border border-gray-700 rounded-lg w-full max-w-3xl max-h-[80vh] flex flex-col shadow-2xl z-50">
      <div class="flex items-center justify-between px-5 py-3 border-b border-gray-700">
        <div class="flex items-center gap-2 flex-wrap">
          <span class="text-white font-semibold text-sm">Version {{ versionNumber }}</span>
        ...
        <button class="text-gray-500 hover:text-gray-300 ml-4 shrink-0" @click="emit('close')">✕</button>
      </div>
