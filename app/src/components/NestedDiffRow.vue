...
const rowClass = computed(() => ({
  'bg-green-950 text-green-300 light:bg-green-50 light:text-green-800': props.status === 'added',
  'bg-red-950 text-red-300 light:bg-red-50 light:text-red-800':    props.status === 'removed',
  'bg-yellow-950 text-yellow-200 light:bg-yellow-50 light:text-yellow-800': props.status === 'modified',
